...
function out_menu($param,$sec_li){
	...
	<ul class="sf-menu">
		...
		<li '.$li3.'>
			...
			<ul>
				...
				<li>'.
					(!empty($sec_li)?'<a href="javascript:;">产品分类 <span style="color:#ccc">&gt;</span></a>':'<a href="javascript:;">产品分类</a>')
					.'<ul>'.
						$sec_li.
					'</ul>
				</li>
		...
		<li '.$li6.'><a HREF="./modules.php">挂件设置</a></li>
